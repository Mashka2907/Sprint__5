...
Пришло время выполнить дополнительный проект. В нём ты закрепишь знания по UI-тестированию.  
Тебе предстоит написать UI-автотесты для учебного сервиса «Доска». Сервис разработали специально для студентов.  
